...
OutputBaseFilename=Pockets-win
OutputDir=./
Compression=lzma
...
[Files]
Source: "Pockets\win64\Pockets.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "Pockets\win64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
