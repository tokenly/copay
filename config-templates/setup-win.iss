...
#define MyAppName "Tokenly Pockets"
#define MyAppVersion "%APP-VERSION%"
#define MyAppPublisher "Tokenly"
#define MyAppURL "http://pockets.tokenly.com"
#define MyAppExeName "Pockets.exe"
...
[Files]
Source: "Tokenly Pockets\win64\pockets.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "Tokenly Pockets\win64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../public/favicons/favicon.ico"; DestDir: "{app}"; DestName: "icon.ico"; Flags: ignoreversion
...
Root: HKCR; Subkey: "pockets"; ValueType: "string"; ValueData: "URL:Pockets Custom Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "pockets"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
